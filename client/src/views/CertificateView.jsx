          ...
          <div className="my-6 space-y-6">
            ...
            <p className="text-sm text-gray-600 max-w-[800px] mx-auto leading-relaxed">
              {studentData.clearanceScope === 'first_semester' ? (
                <>
                  Has successfully fulfilled first semester financial obligations (50% payment threshold) for the <b className="text-secondary font-bold">{studentData.session}</b> Academic Session, including tuition fees, levies, and accommodation fees in respect of the Department of <b className="text-secondary font-bold">{studentData.programme ? studentData.programme.replace('B.Sc. ', '') : 'Computer Science'}</b>. Accordingly, the student is hereby declared <span className="text-primary font-black uppercase text-[12px]">CLEARED (First Semester Only)</span> from the University Bursary. This clearance allows access <span className="text-secondary font-bold">ONLY for first semester exams and activities</span>. To continue in the second semester, the remaining 50% balance must be fully paid. The student is cleared for accommodation and is assigned to stay in <b className="text-secondary font-bold">{hostelName}</b>.
                </>
              ) : (
                <>
                  Has successfully fulfilled all financial obligations for the <b className="text-secondary font-bold">{studentData.session}</b> Academic Session, including tuition fees, levies, and accommodation fees in respect of the Department of <b className="text-secondary font-bold">{studentData.programme ? studentData.programme.replace('B.Sc. ', '') : 'Computer Science'}</b>. Accordingly, the student is hereby declared <span className="text-primary font-black uppercase text-[12px]">Cleared</span> from the University Bursary. The student is cleared for accommodation and is assigned to stay in <b className="text-secondary font-bold">{hostelName}</b>.
                </>
              )}
            </p>
